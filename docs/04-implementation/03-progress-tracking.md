...
| 6A | Authentication provider expansion | Not Started | Email verification and password reset are secure; Google and Facebook sign-in and authenticated linking are secure. | Scope and design decisions recorded. Implementation is planned in `tasks/15-authentication-expansion.md`; Telegram sign-in and sign-up remain deferred. |
